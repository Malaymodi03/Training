$(document).ready(function(){
    ...
    $(document).on("click", ".btnsubmit", function(){ 
        var childrow_index = $(this).siblings().index();
        alert(childrow_index);
        ...
        // $('table tbody').append(`<tr><td>${title}</td></tr>`)
     ...
     $('table').append(`<tr><td colspan="2">${title}</td></tr>`)
        ...
        //     $('.displaydatarow').append(`<tr><td>${subtitle}</td><td>${value}</td></tr></tbody></table>`)
        // }
    ...
    // subtitle = $(this).siblings().find("#subtitle").eq(subtitleindex).val();
        ...
        // childdeleteindex = $(this).siblings('.childrow').find(".btndelete").index();
        
         $('table').append(`<tr><td>${subtitle}</td><td>${value}</td></tr>`)

         //var childrow_index = $(this).siblings().children().index();
         //console.log(childrow_index);
    ...
    //    var  childrow_index = $(this).parent().index();
